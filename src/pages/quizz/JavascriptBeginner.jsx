...
import questions from "../../data/javascript/quiz_javascript_beginner.json";
import CountdownTimer from "../../components/CountdownTimer";

const JavascriptBeginner = ({ duration }) => {
  ...
  useEffect(() => {
    setTimeLeft(duration); // Reset time saat duration berubah
  }, [duration]);
